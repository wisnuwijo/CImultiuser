...
<div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form form-horizontal" action="<?php echo base_url(). 'member/tambah_aksi'; ?>" method="post">
  <div class="section">
  ...
  <div class="form-footer">
    <div class="form-group">
      <div class="col-md-9 col-md-offset-3">
        ...
        <a href="<?php echo base_url(); ?>member/index?mode=biodata" class="btn btn-default">Batal</a>
      </div>
    </div>
  </div>
</form>
