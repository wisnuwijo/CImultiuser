...
<?php $this->load->view('sidebar_m'); ?>
<?php $this->load->view('navbar_m'); ?>
...
<div class="row">
    ...
    <tbody>
        ...
        ?>
            ...
            <td><font size="2pt"><?php echo $u->ttl ?></font></td>
            <td><font size="2pt"><?php echo $u->alamat ?></font></td>
            <td><font size="2pt"><?php echo $u->telepon ?></font></td>
            <td><font size="2pt"><?php echo $u->sekolah ?></font></td>
            <td><font size="2pt"><?php echo $u->hobi ?></font></td>
            <td>
                <a href="<?php echo base_url('member/edit/'.$u->id.'?mode=biodata'); ?>" class="fa fa-edit" title="Edit" ></a>
                <!--<a href="" class="fa fa-close" title="Hapus">Hapus</a>-->
                <?php 
                	$id = $u->id;
                ?>
                <a href="<?php echo base_url('member/hapus/'.$id.'?id='.$u->id.'&mode=biodata'); ?>" title="Hapus" class="fa fa-close" onclick="javascript: return confirm('Anda yakin hapus ?')"></a>
      ...
      <a href="<?php echo base_url(); ?>member/tambah?mode=biodata" class="btn btn-info pull-right " title="Tambah" >Tambah Data</a>
    </div>
    </div>
<!-- MODAL -->
