...
<div class="row">
    ...
    <tbody>
        ...
        ?>
            ...
            <td>
                <a href="<?php echo base_url('biodata/edit/'.$u->id.'?mode=biodata'); ?>" class="fa fa-edit" title="Edit" ></a>
                <!--<a href="" class="fa fa-close" title="Hapus">Hapus</a>-->
                <a href="<?php echo base_url('biodata/hapus/'.$u->id); ?>" class="fa fa-close" onclick="javascript: return confirm('Anda yakin hapus ?')" title="Hapus"></a>
      ...
      <a href="<?php echo base_url(); ?>biodata/tambah?mode=biodata" class="btn btn-info pull-right " title="Tambah" >Tambah Data</a>
    </div>
    </div>
<!-- MODAL -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <?php echo anchor('biodata/hapus/'.$u->id,'Hapus','class='.'"btn btn-danger btn-md"'); ?>
        </div>
      </div>
    </div>
  </div>
